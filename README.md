...
- **2026** — **FinGuard AI** showcased as an Applied ML Benchmark (Sukkur IBA)
- **2025** — Selected, Global Pool — **Harvard Aspire Leaders Program** (Harvard University)
- **2025** — **International ML Summer School**, cohort of 10,000+
- **2025** — Runner-Up, Project Competition — **SIBA Fest**
- **2025** — Merit Award, **PM Youth Laptop Scheme** — top BSCS nationally (Govt. of Pakistan)
...
Global career-readiness program: problem-solving, communication, workplace effectiveness.
